...
export const DEMO_PATHS: LearningPathSummary[] = [
  ...
  },
  {
    ...
    title: {
      de: "Tradinggrundlagen",
      sl: "Osnove trgovanja",
      en: "Trading Foundations",
    },
    summary: {
    ...
    previewTopics: {
      ...
      sl: [
        "Nakupna in prodajna cena",
        "Vrste naročil",
        "Likvidnost",
        "Dolge in kratke pozicije",
      ],
...
export const DEMO_MODULES: AcademyModule[] = [
  ...
  summary: {
    de:
      index === 0
        ? "Ordne Haushalte, Unternehmen, Staaten und Märkte in einem zusammenhängenden System ein."
        : "Ein strukturierter Baustein für belastbare Finanzentscheidungen.",
    sl:
      index === 0
        ? "Poveži gospodinjstva, podjetja, države in trge v enoten sistem."
        : "Strukturiran gradnik za premišljene finančne odločitve.",
    en:
      index === 0
        ? "Connect households, companies, governments, and markets in one coherent system."
        : "A structured building block for durable financial decisions.",
  },
...
export const DEMO_LESSON: DemoLesson = {
  ...
  title: {
    de: "Die Landkarte der Finanzwelt",
    sl: "Zemljevid finančnega sveta",
    en: "A map of the financial world",
  },
  summary: {
  ...
  objectives: {
    de: [
      "Finanzen als System von Entscheidungen erklären",
      "Primär- und Sekundärmärkte unterscheiden",
      "Risiko, Zeit und Information als Kernfaktoren erkennen",
    ],
    sl: [
      "Pojasniti finance kot sistem odločitev",
      "Ločiti primarne in sekundarne trge",
      "Prepoznati tveganje, čas in informacije kot ključne dejavnike",
    ],
    en: [
      "Explain finance as a system of decisions",
      "Distinguish primary and secondary markets",
      "Recognise risk, time, and information as core forces",
    ],
  },
  sections: {
    core: {
  ...
  sourceIds: [
    "European Central Bank — Financial markets",
...
export const DEMO_QUIZ: QuizQuestion[] = [
  {
    ...
    prompt: {
      de: "Wer erhält Kapital bei einer neuen Aktienemission?",
      sl: "Kdo prejme kapital ob novi izdaji delnic?",
      en: "Who receives capital in a new share issuance?",
    },
    options: [
      {
        id: "issuer",
        label: {
          de: "Das emittierende Unternehmen",
          sl: "Podjetje izdajatelj",
          en: "The issuing company",
        },
      },
      {
        id: "exchange",
        label: { de: "Die Börse", sl: "Borza", en: "The exchange" },
      },
      {
        id: "seller",
        label: {
          de: "Ein späterer Verkäufer",
          sl: "Poznejši prodajalec",
          en: "A later seller",
        },
      },
    ],
    ...
    explanation: {
      de: "Im Primärmarkt fließt das Kapital an den Emittenten.",
      sl: "Na primarnem trgu kapital prejme izdajatelj.",
      en: "In the primary market, capital flows to the issuer.",
    },
    alternatives: {
      de: "Die Börse organisiert Handel; ein späterer Verkäufer handelt im Sekundärmarkt.",
      sl: "Borza organizira trgovanje; poznejši prodajalec deluje na sekundarnem trgu.",
      en: "The exchange organises trading; a later seller trades in the secondary market.",
    },
  },
  {
    id: "q-ff-finance-map-2",
    prompt: {
      de: "Welche Funktion erfüllt ein liquider Sekundärmarkt?",
      sl: "Kaj omogoča likviden sekundarni trg?",
      en: "What does a liquid secondary market provide?",
    },
    options: [
      {
        id: "guarantee",
        label: {
          de: "Garantierte Gewinne",
          sl: "Zagotovljen dobiček",
          en: "Guaranteed profits",
        },
      },
      {
        id: "transfer",
        label: {
          de: "Einfacheren Risikotransfer und Preisfindung",
          sl: "Lažji prenos tveganja in oblikovanje cen",
          en: "Easier risk transfer and price discovery",
        },
      },
      {
        id: "free",
        label: {
          de: "Kostenlosen Handel",
          sl: "Brezplačno trgovanje",
          en: "Free trading",
        },
      },
    ],
    ...
    explanation: {
      de: "Liquidität erleichtert Transaktionen und unterstützt Preisfindung, garantiert aber kein Ergebnis.",
      sl: "Likvidnost olajša transakcije in oblikovanje cen, ne zagotavlja pa rezultata.",
      en: "Liquidity makes transactions easier and supports price discovery, but guarantees no outcome.",
    },
    alternatives: {
      de: "Gewinne und Kosten hängen von Risiko, Preis, Gebühren und Ausführung ab.",
      sl: "Dobiček in stroški so odvisni od tveganja, cene, provizij in izvedbe.",
      en: "Profit and cost depend on risk, price, fees, and execution.",
    },
  },
  {
    id: "q-ff-finance-map-3",
    prompt: {
      de: "Was geschieht meist, wenn eine bestehende Aktie an der Börse verkauft wird?",
      sl: "Kaj se navadno zgodi, ko se obstoječa delnica proda na borzi?",
      en: "What usually happens when an existing share is sold on an exchange?",
    },
    options: [
      {
        id: "ownership",
        label: {
          de: "Der Eigentumsanspruch wechselt den Besitzer",
          sl: "Lastniški delež zamenja lastnika",
          en: "The ownership claim changes hands",
        },
      },
      {
        id: "newcapital",
        label: {
          de: "Das Unternehmen erhält immer neues Kapital",
          sl: "Podjetje vedno prejme nov kapital",
          en: "The company always receives new capital",
        },
      },
      {
        id: "debt",
        label: {
          de: "Die Aktie wird automatisch zur Anleihe",
          sl: "Delnica samodejno postane obveznica",
          en: "The share automatically becomes a bond",
        },
      },
    ],
    correctOptionId: "ownership",
    explanation: {
      de: "Sekundärmarkttransaktionen übertragen bestehende Ansprüche zwischen Anlegern.",
      sl: "Posli na sekundarnem trgu prenašajo obstoječe pravice med vlagatelji.",
      en: "Secondary-market transactions transfer existing claims between investors.",
    },
    alternatives: {
      de: "Neue Unternehmensfinanzierung geschieht bei Emissionen; Aktien und Anleihen bleiben verschiedene Instrumente.",
      sl: "Novo financiranje podjetja nastane ob izdaji; delnice in obveznice ostanejo različni instrumenti.",
      en: "New company financing occurs at issuance; shares and bonds remain different instruments.",
    },
  },
];
...
export const DEMO_REVIEW_CARDS: ReviewCardDefinition[] = [
  {
    id: "card-primary",
    front: { de: "Primärmarkt", sl: "Primarni trg", en: "Primary market" },
    back: {
      de: "Markt, auf dem neue Instrumente ausgegeben werden und Kapital an den Emittenten fließt.",
      sl: "Trg, kjer se izdajo novi instrumenti in kapital prejme izdajatelj.",
      en: "The market where new instruments are issued and capital flows to the issuer.",
    },
  },
  {
    id: "card-secondary",
    ...
    back: {
      de: "Markt, auf dem bestehende Instrumente zwischen Anlegern gehandelt werden.",
      sl: "Trg, kjer vlagatelji trgujejo z že izdanimi instrumenti.",
      en: "The market where existing instruments trade among investors.",
    },
  },
  {
    id: "card-liquidity",
    front: { de: "Liquidität", sl: "Likvidnost", en: "Liquidity" },
    back: {
      de: "Wie leicht ein Instrument ohne große Preiswirkung gehandelt werden kann.",
      sl: "Kako zlahka je mogoče trgovati z instrumentom brez velikega vpliva na ceno.",
      en: "How easily an instrument can trade without a large price impact.",
    },
  },
  {
    id: "card-risk",
    front: { de: "Risiko", sl: "Tveganje", en: "Risk" },
    back: {
      de: "Unsicherheit über mögliche Ergebnisse, nicht nur die Wahrscheinlichkeit eines Verlusts.",
      sl: "Negotovost glede možnih izidov, ne le verjetnost izgube.",
      en: "Uncertainty about possible outcomes, not merely the chance of loss.",
    },
  },
];
...
export const DEMO_GLOSSARY: GlossaryDefinition[] = [
  {
    id: "term-primary-market",
    term: { de: "Primärmarkt", sl: "Primarni trg", en: "Primary market" },
    definition: DEMO_REVIEW_CARDS[0].back,
  },
  {
    id: "term-secondary-market",
    term: { de: "Sekundärmarkt", sl: "Sekundarni trg", en: "Secondary market" },
    definition: DEMO_REVIEW_CARDS[1].back,
  },
  {
    id: "term-liquidity",
    term: { de: "Liquidität", sl: "Likvidnost", en: "Liquidity" },
    definition: DEMO_REVIEW_CARDS[2].back,
  },
  {
    id: "term-spread",
    term: { de: "Spread", sl: "Razmik", en: "Spread" },
    definition: {
      de: "Differenz zwischen bestem Kauf- und Verkaufspreis.",
      sl: "Razlika med najboljšo nakupno in prodajno ceno.",
      en: "The difference between the best bid and ask prices.",
    },
  },
  {
    id: "term-r-multiple",
    term: { de: "R-Multiple", sl: "R-količnik", en: "R multiple" },
    definition: {
      de: "Ergebnis eines Trades relativ zum vorher geplanten Risiko.",
      sl: "Rezultat posla glede na vnaprej načrtovano tveganje.",
      en: "A trade result measured against its pre-planned risk.",
    },
  },
  {
    id: "term-drawdown",
    term: { de: "Drawdown", sl: "Padec vrednosti", en: "Drawdown" },
    definition: {
      de: "Rückgang vom bisherigen Kapitalhoch zum folgenden Tief.",
      sl: "Padec od prejšnjega vrha kapitala do naslednjega dna.",
      en: "The decline from an equity peak to a subsequent trough.",
    },
  },
];
...
function createCandles(): DemoCandle[] {
  ...
  for (let index = 0; index < 48; index += 1) {
    ...
    candles.push({
      ...
      high: Number(
        (Math.max(open, close) + 0.45 + (index % 3) * 0.08).toFixed(2),
      ),
...
export const DEMO_SCENARIO: DemoScenario = {
  ...
  title: {
    de: "Trendfortsetzung mit Rücksetzer",
    sl: "Nadaljevanje trenda po popravku",
    en: "Trend continuation after a pullback",
  },
  context: {
